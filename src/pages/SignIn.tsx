    ...
    return (
        <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
            ...
            <footer className="flex flex-col items-center gap-4 mt-8">
                <a href="">
                    <Text size="sm" className="text-gray-400 underline hover:text-gray-200">Esqueceu sua senha?</Text>
                </a>
                <a href="">
                    <Text size="sm" className="text-gray-400 underline hover:text-gray-200">Não possui conta? Crie uma agora!</Text>
                </a>
            </footer>
        </div>
    );
